...
Route::delete("favorit/hapus/{id}", [favoritController::class, 'hapus'])->name("hapus_favorit");
                        ...
                        //proses memasukkan dan save data saran
 Route::get("saran/buat", [saranController::class, 'buat'])->name("buat_saran");
 Route::post("saran/simpan", [saranController::class, 'simpan'])->name("simpan_saran");

//proses tampilkan saran
Route::get("saran/tampil/{id}", [saranController::class, 'tampil'])->name("tampil_saran");
 Route::get("saran/semua", [saranController::class, 'semua'])->name("semua_saran");

//ubah saran
Route::get("saran/ubah/{id}", [saranController::class, 'ubah'])->name("ubah_saran");
 Route::put("saran/update/{id}", [saranController::class, 'update'])->name("update_saran");

//hapus saran
Route::delete("saran/hapus/{id}", [saranController::class, 'hapus'])->name("hapus_saran");
